        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-white mb-4">
              {t('footer.getApp.title')}
            </h3>
            <p className="text-gray-400 mb-6">
              {t('footer.getApp.subtitle')}
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <div className="text-xs opacity-75">{t('download.appStoreTop')}</div>
                  <div className="text-lg font-semibold">{t('download.appStoreBottom')}</div>
                </div>
                <motion.div
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <div className="text-xs opacity-75">{t('download.playStoreTop')}</div>
                  <div className="text-lg font-semibold">{t('download.playStoreBottom')}</div>
                </div>
                <motion.div
                  className="opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  initial={{ x: -10 }}
          ...
          <p className="text-center text-yellow-200 font-semibold mt-10 whitespace-pre-line">
            {t('footer.notice')}
          </p>
        </motion.div>
